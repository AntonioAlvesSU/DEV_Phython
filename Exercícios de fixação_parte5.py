...
#44-Receba a altura do grau de uma escada e a altura que o usuário deseja alcançar
# subindo a escada.Calcule e mostre quantos degraus o usuário deverá subir para atingir o objetivo:
import math

print('Por favor ensira o valor da altura do degrau= ')
altura_degrau= float(input("Valor é : "))
print('Por favor ensira o número da altura a ser atingida= ')
altura_meta = float(input("Valor é : "))
Total_degraus=altura_meta / altura_degrau

print('valor da altura do degrau= ', altura_degrau  )
print('altura a ser atingida = ', altura_meta )
print('Total de degraus =  ',  Total_degraus )

#45-Faça um progrma para converter uma letra maiúscula e minuscula . Use a tablea ASCII para resolver probela.

print('Por favor ensira o valor da tabela ASCII= ')
ASC_lettle= int(input("Valor é : "))
res= chr(ASC_lettle)
print('Resultado da letra convertida em maiúscula= ', res.upper())

#46-Faça um progrma que leia um número inteiro de três digitos (100 a 999). Gere outro número formado pelos dígitos invertidos
# do número lido, ex.: 123 => 321

print('Por favor ensira o valor numérico de três dígitos positivos entre 100 e 999:')
vl= (input("Valor é : "))
reversed(vl)
print('Resultado do valor informado invertido= ', ''.join(reversed(vl)),len(''.join(reversed(vl)))==3)

"""

#47-Faça um progrma que leia um número inteiro de quatro digitos (1000 a 9999). e imprima
# do número lido, ex.: 123 => 321

print('Por favor ensira o valor numérico de três dígitos positivos entre 1000 e 9999:')
vl= (input("Valor é : "))
print(len(vl) == 4)
print('Resultado do valor informado invertido= ', vl )
